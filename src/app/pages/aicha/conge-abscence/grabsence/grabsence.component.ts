  ...
  initPersmission(id:number){
    ...
    this.service.getPermissionsByStructureId(id)
      .subscribe(
        (data:any)=>{
          this.absences = data;
          console.log("initPersmission", data)
...
initUsers(id:number){
  ...
  onStatut(value: any) {
    ...
    console.log('this.absences',this.absences)
    this.service.getPermissionsByStructureId(this.structureId)
      .subscribe(
        (data:any)=>{
          this.absences = data;
          this.absences = this.absences.filter(val => val.statut==value);
          console.log('this.absences',this.absences)
          this.dataSource = new MatTableDataSource(this.absences.reverse());
          this.dataSource.paginator = this.paginator;
          this.dataSource.sort = this.sort;
